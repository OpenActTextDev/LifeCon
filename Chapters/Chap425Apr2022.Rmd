...
<!-- Later equations only properly knit if this is beforehand once in the code -->
...
$$
\mathrm{E} \left(_{r/m}B\right) = \left\{
\begin{array}{cccc}
...
The general population data are drawn from the [Human Mortality Database](http://www.mortality.org/). These data are organized in Appendix Section \@ref(Sec:KoreanMortality).
...
**Example 4.2.2. Mortality by Country (Japan, Poland, and the United States).** This example focuses on population mortality and so recent 2019 experience is available from the [Human Mortality Database](http://www.mortality.org/). These data are organized in Appendix Section \@ref(Sec:MortalityCountry). In addition to classification by country, we also look at experience by sex and age as these distinctions are well known.
