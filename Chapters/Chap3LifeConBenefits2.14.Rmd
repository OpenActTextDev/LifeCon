...
**Example 3.2. Life Insurance by Selected Attributes**. To illustrate, consider the Section 2.7 mortality. As a baseline, we consider a healthy female that is not a smoker, not obese, and has an average blood pressure level equal to 114 as well as an interest rate of 4%.
