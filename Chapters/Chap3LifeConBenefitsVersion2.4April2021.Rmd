...
plot.window(xlim=c(0,14),ylim=c(3,8))
...
text(5,4,TeX("Pr(_0B=1)"))
text(7,4,TeX("Pr(_1B=1)"))
text(9,4,TeX("Pr(_2B=1)"))
text(11,4,TeX("Pr(_3B=1)"))
text(13.5,4,"...")
box(col = 'lightblue')
...
<iframe width="650" height="520" frameborder="1" scrolling="no"  align="middle" src="https://onedrive.live.com/embed?resid=9F1B70CE7B0595D1%211721&authkey=%21AKZxnb5t3WqUBGM&em=2&AllowTyping=True&wdHideGridlines=True&wdDownloadButton=True&wdInConfigurator=True"></iframe>
...
```{r Benefit4a, ref.label = 'Benefit4', fig.cap = '(ref:Benefit4)',  fig.width=6, fig.height=2.5, echo = FALSE}
```
...
```{r Benefit5a, ref.label = 'Benefit5', fig.cap = '(ref:Benefit5)', fig.width=6, fig.height=2.5, echo = FALSE}
```
...
```{r Benefit6a, ref.label = 'Benefit6', fig.cap = '(ref:Benefit6)', fig.width=6, fig.height=2.5, echo = FALSE}
```
...
```{r Benefit7a, ref.label = 'Benefit7', fig.cap = '(ref:Benefit7)', fig.width=6, fig.height=2.5, echo = FALSE}
```
...
The [Display 3.2] worksheet contains the underlying Life Table used. The yellow highlighted $q_x$ cells can be adjusted as desired.
