...
Imagine a financial system with a cash flow of known value $_tC$ occuring in $t$ years from now. If we assume the spot rate of interest is $_ti$ per annum effective, then the present value ($PV$) of this cash flow is:
