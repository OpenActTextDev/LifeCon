...
## Canadian Female Select and Ultimate Mortality Table
...
```{r echo = FALSE}
scipen=9
#CanadianSelect <- read.csv("../../MortalityData/CanadianFemaleSelect.csv", stringsAsFactors = FALSE)
CanadianSelect <- read.csv("../MortalityData/CanadianFemaleSelect.csv", stringsAsFactors = FALSE)
...
```{r echo = FALSE}
scipen=9
#CanadianUlt<- read.csv("../../MortalityData/CanadianFemaleUltimate.csv", stringsAsFactors = FALSE)
CanadianUlt <- read.csv("../MortalityData/CanadianFemaleUltimate.csv", stringsAsFactors = FALSE)
...
## Korean Mortality by Insured Status 
...
```{r echo = FALSE}
KoreaPop <- read.csv("../MortalityData/KoreaMx_1x1.csv")
#KoreaPop <- read.csv("../../MortalityData/KoreaMx_1x1.csv")
