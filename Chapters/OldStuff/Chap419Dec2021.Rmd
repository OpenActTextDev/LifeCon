...
```{r SurvSexNeut, warning=FALSE, message=FALSE,  comment=NA, fig.cap = '(ref:SurvSexNeut)', fig.align="center", echo = FALSE}
library(data.table)
library(survival)
...
```{r SurvBreed, warning=FALSE, message=FALSE,  comment=NA, fig.cap = '(ref:SurvBreed)', fig.align="center", echo = FALSE}
par(mfrow=c(1,1))
...
```{r DogCoxPHa, ref.label = 'DogCoxPH', echo = FALSE, warning=FALSE, message=FALSE,  comment=NA}
```
...
```{r OneYearCrossBreeda, ref.label = 'OneYearCrossBreed', warning=FALSE, message=FALSE,  comment=NA, fig.cap = '(ref:OneYearCrossBreed)', fig.align="center",  out.width = '50%', echo = FALSE}
```
...
```{r OneYearCrossBreed1a, ref.label = 'OneYearCrossBreed1', warning=FALSE, message=FALSE,  comment=NA, fig.align="center", echo = FALSE}
