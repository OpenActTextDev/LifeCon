---
title:  "The Mathematics, Statistics, and Economics of Life Contingencies: Experiments with jExcel"
...
output:
  bookdown::html_document2:
   ...
   # code_folding: hide
    ...
    includes:
      in_header: WritingSupportFiles/ShowHideLC.js
  # bookdown::pdf_book:     
  #   number_sections: yes
  #   toc: yes
  #   toc_depth: '3'
...
```{r echo = FALSE, child='WritingSupportFiles/GlossaryA.Rmd', warning=FALSE,message=FALSE}
```
...
# Examples -- Valuation of cash flows under uncertainty
...
data311 <- read.csv("LC_Example_3.1.csv", header = F)
...
var mySpreadsheet311 = jexcel(document.getElementById('spreadsheetLC311'), {
    data: data311,
    columns: [
       { type: 'text', width:'280', 'align': 'left' },
...
```{r echo=ECHOCODE}
# Import data from CSV file, then convert so it can be used in Javascript
data312 <- read.csv("LC_Example_3.2.csv", header = F)
...
function myFunctionDownload() {mySpreadsheet312.download();};
...
<span style="font-size: small; color: green;"> Editorial Note: As of now, I (Jed) do not know how to make two graphs on the same page update dynamically. Further, when we use the "pagination" option to reduce the size of a table, dynamic graphs becomes hard (although the dynamic tables are still really easy).</span>
