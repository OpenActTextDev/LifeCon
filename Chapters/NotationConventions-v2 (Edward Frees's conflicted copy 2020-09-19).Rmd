---
title:  "Conventions for Notation"
...
bibliography: ["WritingSupportFiles/LDAReference2020A.bib"]
...
<!-- ```{r echo = FALSE, child="temp_path/Packages.Rmd", warning=FALSE,message=FALSE} -->
<!-- ``` -->

```{r echo = FALSE, child='WritingSupportFiles/PdfOutput.Rmd', warning=FALSE,message=FALSE}
```

```{r echo = FALSE, child='WritingSupportFiles/Glossary.Rmd', warning=FALSE,message=FALSE, eval = FALSE}
```

`r if (knitr:::is_html_output()) '$\\require{enclose}$'`


# Appendix E: Conventions for Notation  {#C:NotationConvention}
