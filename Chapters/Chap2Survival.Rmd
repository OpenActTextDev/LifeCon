...
colnames(tmp_life_table_us_mx_fem_2014)[c(4,5)]<- c("qx US Females","lx US Females")
rownames(tmp_life_table_us_mx_fem_2014) <- NULL
datatable(tmp_life_table_us_mx_fem_2014)
...
colnames(tmp_life_table_us_mx_mal_2014)[c(4,5)]<- c("qx US Males","lx US Males")
rownames(tmp_life_table_us_mx_mal_2014) <- NULL
datatable(tmp_life_table_us_mx_mal_2014) 
```
...
Kaplan-Meier and Nelson-Aalen. Please check out the [Loss Data Analysis descriptions](https://ewfrees.github.io/Loss-Data-Analytics/C-ModelSelection.html#nonparametric-estimation-using-modified-data) of these topics.
